...
This version is for printing pages with the Ctrl + pagedown requirement
'''
...
def main():
    ...
    print("Welcome to the VitalSource Ebook Printer!\nThis version handles the page-down requirement for standard pages")
    ...
    def NumberProcess(start, inputLastPageList):
        for page in range(start, len(NumberList), 2): 
                ...
                if page in inputLastPageList or (page+1) in inputLastPageList : #checks if a last page was found
                        pyautogui.hotkey('ctrl', 'pagedown', interval = 0.25)   
